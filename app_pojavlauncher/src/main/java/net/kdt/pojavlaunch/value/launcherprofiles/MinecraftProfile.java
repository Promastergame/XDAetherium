...
public class MinecraftProfile {
	...
	public boolean isCustomModpack;
	public String modLoader;
	public java.util.List<net.kdt.pojavlaunch.modloaders.modpacks.models.ModItem> installedMods;
	...
	public MinecraftProfile(MinecraftProfile profile){
		...
		isCustomModpack = profile.isCustomModpack;
		modLoader = profile.modLoader;
		if (profile.installedMods != null) {
			installedMods = new java.util.ArrayList<>(profile.installedMods);
		}
	}
}
