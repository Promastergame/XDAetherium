...
public class SearchModFragment extends Fragment implements ModItemAdapter.SearchResultCallback {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            mIsCustomModpack = getArguments().getBoolean("is_custom_modpack", false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mModItemAdapter.setCustomModpackConfig(mIsCustomModpack, mProfileId);
    ...
    private void displayFilterDialog() {
        if (mIsCustomModpack) return; // Disable version filtering in custom modpack mode
