...
public class ControlData {
    ...
    public int buttonImageDisplayMode; // 0 = always, 1 = on_press
    ...
    public ControlData(ControlData controlData) {
        ...
        this.buttonImagePath = controlData.buttonImagePath;
        this.buttonImageDisplayMode = controlData.buttonImageDisplayMode;
    }
