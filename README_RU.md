...
- **Обновлённый установщик загрузчиков модов**:
  ...
  - Добавлена основа для BTW (Better Than Wolves): интерфейс готов, логика скачивания и совместимости находится в разработке.
...
- **Продвинутое кастомное управление и кастомизация фона**:
  - **Персонализированный фон раскладки (Бета)**: возможность устанавливать собственные фоновые изображения или фотографии прямо под оверлей кастомного управления. Добавлена удобная палитра выбора цветов (в следующих обновлениях планируются дальнейшие улучшения!).
  ...
  <p align="center">
    <img src="docs/кастом_фоны_русс.jpg" width="280" alt="Персонализированный фон раскладки">
